...
overflow-y:scroll; max-height: 200px}"),
           ...
           tabPanel("About this app",
                    tags$div(
                      ...
                      "In late 2019, cases of severe respiratory illness caused by a new type of coronavirus were reported across Wuhan, the capital of Hubei Province in China. The disease is now commonly referred to as COVID-19. By January 2020, the virus had escaped the borders of China and the number of COVID-19 cases began to rise around the world. The COVID-19 pandemic has dramatically affected everyone's life in some way across the entire world. This global pandemic has made social distancing and wearing face masks in public the new norm. ",
                      tags$br(),tags$br(),
                      "Rajeev and Alex are both graduate students at American University in Washington D.C. Over the last year, they diligently tracked various metrics from the COVID Tracking Project at ", tags$i("The Atlantic"), " regarding COVID-19 in the Washington metropolitan area. They closely monitored both the number of new daily cases and deaths over the past 15 months in anticipation that each of 3 metrics would decline as fast as possible. Doing this inspired them to make an interactive web app using the shiny package in R to better visualize the different metrics. They created interactive time series plots for both monthly Covid-19 cases and deaths in Washington, D.C., Maryland and Virginia. In addition, a frequency plot for the cumulative number of Covid-19 cases in the 3 regions over the 15-month span was also produced. All of the interactive data visualizations have slider bars so individuals can view the specific time period that they desire when viewing the specific data visualizations. Finally, an interactive table of descriptive statistics was also created under the Data tab to allow for the viewers of the shiny app to become even more well-acquainted with the Covid-19 data.",
